// src/utils/animations/bta/rend/filters.js
// ponytail: convertido de ESM a script clasico. Expuesto via window.BTA_filters.
function applyFilterAndDraw(targetCtx, element, drawCallback) {
  let blurVal = 0;
...
if (typeof window !== "undefined") {
  window.BTA_filters = { applyFilterAndDraw };
}
