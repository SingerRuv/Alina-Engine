class MainMenuScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.itemNames = [ "storymode", "freeplay", "multiplayer", "options", "credits"];
  ...
  create() {
    ...
    // Discord RPC: en el menú principal
    if (window.DiscordRPC && typeof window.DiscordRPC.setMenu === "function") {
      window.DiscordRPC.setMenu();
    }
