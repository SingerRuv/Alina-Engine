...
class RatingLogic {
  ...
  getValidRating(requested) {
    // El skin no tiene "perfect" ni "killer", solo "sick" como mejor.
    // Si piden "perfect" o "killer", bajamos directamente a "sick".
    if (requested === "perfect" || requested === "killer") requested = "sick";
  ...
  onNoteHit(data) {
    ...
    // popup del bot visible durante botplay
